...
--
-- Host: localhost
-- Generation Time: Aug 29, 2013 at 02:08 PM
...
INSERT INTO `product` (`pid`, `name`, `desc`, `cat_id`, `price`, `application`, `specs`, `cataloge`, `image`, `status`, `product_meta`, `featured`, `review`, `stock`, `image2`, `image3`, `product_meta_key`, `heading_image`, `payment`, `shipping`) VALUES
...
(40, 'Ham Radio Products', '1', 'e020e-product.jpg'),
