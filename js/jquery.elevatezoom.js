...
(function( $, window, document, undefined ) {
	var ElevateZoom = {
			...
			startZoom: function( ) {
				...
				self.nzWidth = self.$elem.width() + 6;
				self.nzHeight = self.$elem.height() + 6;
				...
				if(self.options.imageCrossfade){
					self.zoomWrap = self.$elem.wrap('<div style="border:1px solid #aeacac;padding:2px;height:'+self.nzHeight+'px;width:'+self.nzWidth+'px;" class="zoomWrapper" />');        
