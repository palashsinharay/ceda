...
Name*
                     ...
                     <td >
                        <div id="contact_form_Name_errorloc">
                        </div>
...
Email*
                     ...
                     <td >
                        <div id="contact_form_Email_errorloc">
                        </div>
...
Province&nbsp; (Non-US residents only)
                     ...
                     <td >
                        <select size="1" name="StateProvince" id="stateprovince">
                           <option value="Australian_Capital_Territory">
Australian Capital Territory
                           </option>
                           <option value="New_South_Wales">
New South Wales
                           </option>
                           <option value="Northern_Territory">
Northern Territory
                           </option>
                           <option value="Queensland">
Queensland
                           </option>
                           <option value="South_Australia">
South Australia
                           </option>
...
Victoria
                           ...
                           <option value="Western_Australia">
Western Australia
                           </option>
...
Newfoundland and Labrador
                           ...
                           <option value="Northwest_Territories">
...
Chhattisgarh
                           ...
                           <option value="Dadra_and_Nagar_Haveli">
Dadra and Nagar Haveli
                           </option>
                           <option value="Daman_and_Diu">
Daman and Diu
                           </option>
                           <option value="Delhi">
Delhi
...
Bolivia
                           ...
                           <option value="BosniaAndHerzegowina">
Bosnia And Herzegowina
                           </option>
                           <option value="Botswana">
Botswana
                           </option>
                           <option value="BouvetIslandBouvetIsland">
...
Canada
                           ...
                           <option value="CapeVerde">
Cape Verde
                           </option>
                           <option value="CaymanIslands">
Cayman Islands
                           </option>
...
Ethiopia
                           ...
                           <option value="FalklandIslands">
Falkland Islands (Malvinas)
                           </option>
                           <option value="FaroeIslands">
Faroe Islands
                           </option>
                           <option value="Fiji">
Fiji
...
Metropolitan France
                           ...
                           <option value="FrenchGuiana">
French Guiana
                           </option>
                           <option value="FrenchPolynesia">
French Polynesia
                           </option>
...
Haiti
                           ...
                           <option value="HeardAndMcDonaldIslands">
...
Kiribati
                           ...
                           <option value="DemocraticPeoplesRepublicOfKorea">
Democratic People's Republic Of Korea
                           </option>
                           <option value="RepublicOfKorea">
Republic Of Korea
                           </option>
                           <option value="Kuwait">
Kuwait
...
Kyrgyzstan
                           ...
                           <option value="LaoPeoplesDemocraticRepublic">
...
Macau
                           ...
                           <option value="TheFormerYugoslavRepublicOfMacedonia">
...
Mexico
                           ...
                           <option value="FederatedStatesOfMicronesia">
Federated States Of Micronesia
                           </option>
                           <option value="RepublicOfMoldova">
Republic Of Moldova
                           </option>
                           <option value="Monaco">
Monaco
...
Sri Lanka
                           ...
                           <option value="StHelena">
St. Helena
                           </option>
                           <option value="StPierreAndMiquelon">
...
Suriname
                           ...
                           <option value="SvalbardAndJanMayenIslands">
...
Virgin Islands (U.S.)
                           ...
                           <option value="WallisAndFutunaIslands">
Wallis And Futuna Islands
                           </option>
                           <option value="WesternSahara">
Western Sahara
                           </option>
                           <option value="Yemen">
Yemen
...
Zimbabwe
                  ...
                  <tr>
                     ...
                     <td >
                        <div  id="contact_form_Message_errorloc">
                        </div>
<textarea rows="5" cols="30" name="Message" id="message"></textarea>
                  ...
                  <tr>
                     <td align="right" colspan="2">
                        <div  id="contact_form_Submit_errorloc">
                        </div>
                        <input type="submit" value="Submit" name="Submit" id="submit_contact">
                     </td>
                  </tr>
